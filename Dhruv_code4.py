...
while not valid :
    ...
    if 0<=t_col<=7 and 0<=t_row<=7 :
        valid = True
    else :
        print('Enter a valid target cell')
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN :
                ...
                x_wall = x-x_dist
                y_wall = y-y_dist
                x_wall = int((x_wall/75)*2)
                y_wall = int((y_wall / 75)*2)
                ...
                elif check_t == True and y_dist < 7:
