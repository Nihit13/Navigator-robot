...
# Calling the wall revert function
wall_revert()
...
font = pygame.font.Font('SHOWG.TTF', 15)
font2 = pygame.font.Font('SHOWG.TTF', 15)
...
# This function allows the user to save the wall configuration for the next usage
def save_wall():
...
def start_screen(close):
    ...
    while running:
        ...
        write(150, 125, 'To open the latest saved maze, press O ', (255,255,255))
...
def click_detect(close):
    ...
    while running:
        ...
        write(0, 625, 'To save the walls press S', (40, 185, 50))
        pygame.display.update()
    if save:
        save_wall()
